export default {
  'user.login.sk.remember': 'Remeber Password',
  'user.login.account.register': 'Register Account',
  'user.login.others': 'Other Logins:',
  'user.login.cas.login': 'CAS Login',
  'user.login.failed': 'Login Failed',
  'user.login.error.occurred.try': 'An error occurred in the request. Please try again later',
  'user.login.unrecognized.information': 'Unrecognized information transmission',
