...
define(['exports', './Cartesian2-cdd21d41', './Math-2649012a', './Transforms-b24a46f8'], (function (exports, Cartesian2, Math$1, Transforms) { 'use strict';
    ...
    EllipseGeometryLibrary.raisePositionsToHeight = function (positions, options, extrude) {
        ...
        for (var i = 0; i < length; i += 3) {
            ...
            var scaledNormal = Cartesian2.Cartesian3.multiplyByScalar(normal, height, scratchCartesian3);
    ...
    EllipseGeometryLibrary.computeEllipsePositions = function (options, addFillPositions, addEdgePositions) {
        ...
        var numPts = 1 + Math.ceil(Math$1.CesiumMath.PI_OVER_TWO / granularity);

        var deltaTheta = Math$1.CesiumMath.PI_OVER_TWO / (numPts - 1);
        var theta = Math$1.CesiumMath.PI_OVER_TWO - numPts * deltaTheta;
        if (theta < 0.0) {
        ...
        for (i = 1; i < numPts + 1; ++i) {
            ...
            if (addFillPositions) {
                ...
                for (j = 1; j < numInterior - 1; ++j) {
                    t = j / (numInterior - 1);
                    interiorPosition = Cartesian2.Cartesian3.lerp(position, reflectedPosition, t, scratchCartesian3);
...
//# sourceMappingURL=EllipseGeometryLibrary-1b413b53.js.map
