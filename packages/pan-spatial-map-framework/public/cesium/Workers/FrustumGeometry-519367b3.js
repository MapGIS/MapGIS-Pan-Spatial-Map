...
define(['exports', './Transforms-428723c7', './Cartesian2-a7398fe3', './Check-f996273c', './ComponentDatatype-9859adcf', './when-ae2e0b60', './GeometryAttribute-24498485', './GeometryAttributes-5ce4955a', './Math-ea295399', './Plane-2eddca04', './VertexFormat-69b61abe'], (function (exports, Transforms, Cartesian2, Check, ComponentDatatype, when, GeometryAttribute, GeometryAttributes, Math$1, Plane, VertexFormat) { 'use strict';
    ...
    function update$3(frustum) {
        //>>includeStart('debug', pragmas.debug);
        if (!when.defined(frustum.right) || !when.defined(frustum.left) || !when.defined(frustum.top) || !when.defined(frustum.bottom) || !when.defined(frustum.near) || !when.defined(frustum.far)) {
    ...
    OrthographicOffCenterFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
        return (
            ...
            (when.defined(other) &&
                other instanceof OrthographicOffCenterFrustum &&
                Math$1.CesiumMath.equalsEpsilon(this.right, other.right, relativeEpsilon, absoluteEpsilon) &&
                Math$1.CesiumMath.equalsEpsilon(this.left, other.left, relativeEpsilon, absoluteEpsilon) &&
                Math$1.CesiumMath.equalsEpsilon(this.top, other.top, relativeEpsilon, absoluteEpsilon) &&
                Math$1.CesiumMath.equalsEpsilon(this.bottom, other.bottom, relativeEpsilon, absoluteEpsilon) &&
                Math$1.CesiumMath.equalsEpsilon(this.near, other.near, relativeEpsilon, absoluteEpsilon) &&
                Math$1.CesiumMath.equalsEpsilon(this.far, other.far, relativeEpsilon, absoluteEpsilon))
        );
    };
    ...
    OrthographicFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
        ...
        return (
            Math$1.CesiumMath.equalsEpsilon(this.width, other.width, relativeEpsilon, absoluteEpsilon) &&
            Math$1.CesiumMath.equalsEpsilon(this.aspectRatio, other.aspectRatio, relativeEpsilon, absoluteEpsilon) &&
    ...
    PerspectiveFrustum.prototype.equalsEpsilon = function (other, relativeEpsilon, absoluteEpsilon) {
        ...
        return (
            Math$1.CesiumMath.equalsEpsilon(this.fov, other.fov, relativeEpsilon, absoluteEpsilon) &&
            Math$1.CesiumMath.equalsEpsilon(this.aspectRatio, other.aspectRatio, relativeEpsilon, absoluteEpsilon) &&
            this._offCenterFrustum.equalsEpsilon(other._offCenterFrustum, relativeEpsilon, absoluteEpsilon)
        );
    };
...
//# sourceMappingURL=FrustumGeometry-519367b3.js.map
