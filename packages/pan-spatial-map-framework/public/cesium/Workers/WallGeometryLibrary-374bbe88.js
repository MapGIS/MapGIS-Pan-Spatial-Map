...
define(['exports', './arrayRemoveDuplicates-3d6044aa', './Cartesian2-a7398fe3', './when-ae2e0b60', './Math-ea295399', './PolylinePipeline-46691d46'], (function (exports, arrayRemoveDuplicates, Cartesian2, when, Math, PolylinePipeline) { 'use strict';
    ...
    function latLonEquals(c0, c1) {
        return Math.CesiumMath.equalsEpsilon(c0.latitude, c1.latitude, Math.CesiumMath.EPSILON10) && Math.CesiumMath.equalsEpsilon(c0.longitude, c1.longitude, Math.CesiumMath.EPSILON10);
    }
    ...
    WallGeometryLibrary.computePositions = function (ellipsoid, wallPositions, maximumHeights, minimumHeights, granularity, duplicateCorners) {
        ...
        var minDistance = Math.CesiumMath.chordLength(granularity, ellipsoid.maximumRadius);
...
//# sourceMappingURL=WallGeometryLibrary-374bbe88.js.map
