...
define(['exports', './Check-f996273c', './when-ae2e0b60', './Transforms-399eae97', './Math-ea295399'], (function (exports, Check, when, Transforms, Math$1) { 'use strict';
    ...
    function Color(red, green, blue, alpha) {
         ...
         * @default 1.0
         */
        this.red = isCesiumColorNumber(when.defaultValue(red, 1.0));
        /**
         * The green component.
         * @type {Number}
         * @default 1.0
         */
        this.green = isCesiumColorNumber(when.defaultValue(green, 1.0));
        /**
         * The blue component.
         * @type {Number}
         * @default 1.0
         */
        this.blue = isCesiumColorNumber(when.defaultValue(blue, 1.0));
        /**
         * The alpha component.
         * @type {Number}
         * @default 1.0
         */
        this.alpha = isCesiumColorNumber(when.defaultValue(alpha, 1.0));
    }
    ...
    Color.fromCartesian4 = function (cartesian, result) {
        ...
        result.red = isCesiumColorNumber(cartesian.x);
        result.green = isCesiumColorNumber(cartesian.y);
        result.blue = isCesiumColorNumber(cartesian.z);
        result.alpha = isCesiumColorNumber(cartesian.w);
        return result;
    };
    ...
    Color.fromBytes = function (red, green, blue, alpha, result) {
        red = Color.byteToFloat(isCssColorNumber(when.defaultValue(red, 255.0)));
        green = Color.byteToFloat(isCssColorNumber(when.defaultValue(green, 255.0)));
        blue = Color.byteToFloat(isCssColorNumber(when.defaultValue(blue, 255.0)));
        alpha = Color.byteToFloat(isCssColorNumber(when.defaultValue(alpha, 255.0)));
    ...
    Color.fromAlpha = function (color, alpha, result) {
        ...
        result.red = isCesiumColorNumber(color.red);
        result.green = isCesiumColorNumber(color.green);
        result.blue = isCesiumColorNumber(color.blue);
        result.alpha = isCesiumColorNumber(alpha);
        return result;
    };
    ...
    Color.fromHsl = function (hue, saturation, lightness, alpha, result) {
        hue = isCesiumColorNumber(when.defaultValue(hue, 0.0) % 1.0);
        saturation = isCesiumColorNumber(when.defaultValue(saturation, 0.0));
        lightness = isCesiumColorNumber(when.defaultValue(lightness, 0.0));
        alpha = isCesiumColorNumber(when.defaultValue(alpha, 1.0));
...
//# sourceMappingURL=Color-b419d668.js.map
