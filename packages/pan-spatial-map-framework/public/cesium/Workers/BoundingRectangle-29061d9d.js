...
define(['exports', './Cartesian2-a7398fe3', './Check-f996273c', './when-ae2e0b60', './Transforms-399eae97'], (function (exports, Cartesian2, Check, when, Transforms) { 'use strict';
    ...
    var defaultProjection = new Transforms.GeographicProjection();
    var fromRectangleLowerLeft = new Cartesian2.Cartographic();
    var fromRectangleUpperRight = new Cartesian2.Cartographic();
    /**
    ...
    BoundingRectangle.equals = function (left, right) {
        return left === right || (when.defined(left) && when.defined(right) && left.x === right.x && left.y === right.y && left.width === right.width && left.height === right.height);
    };
...
//# sourceMappingURL=BoundingRectangle-29061d9d.js.map
