...
define(['exports', './Cartesian2-a7398fe3', './Transforms-428723c7', './Check-f996273c', './when-ae2e0b60', './Math-ea295399'], (function (exports, Cartesian2, Transforms, Check, when, Math) { 'use strict';
    ...
    function Plane(normal, distance) {
        ...
        if (!Math.CesiumMath.equalsEpsilon(Cartesian2.Cartesian3.magnitude(normal), 1.0, Math.CesiumMath.EPSILON6)) {
    ...
    Plane.projectPointOntoPlane = function (plane, point, result) {
        ...
        var scaledNormal = Cartesian2.Cartesian3.multiplyByScalar(plane.normal, pointDistance, scratchCartesian);
    ...
    Plane.transform = function (plane, transform, result) {
        ...
        var inverseTranspose = Transforms.Matrix4.inverseTranspose(transform, scratchInverseTranspose);
        var planeAsCartesian4 = Transforms.Cartesian4.fromElements(normal.x, normal.y, normal.z, distance, scratchPlaneCartesian4);
        planeAsCartesian4 = Transforms.Matrix4.multiplyByVector(inverseTranspose, planeAsCartesian4, planeAsCartesian4);

        // Convert the transformed plane to Hessian Normal Form
        var transformedNormal = Cartesian2.Cartesian3.fromCartesian4(planeAsCartesian4, scratchTransformNormal);

        planeAsCartesian4 = Transforms.Cartesian4.divideByScalar(planeAsCartesian4, Cartesian2.Cartesian3.magnitude(transformedNormal), planeAsCartesian4);
    ...
    Plane.equals = function (left, right) {
        ...
        return left.distance === right.distance && Cartesian2.Cartesian3.equals(left.normal, right.normal);
    };
...
//# sourceMappingURL=Plane-2eddca04.js.map
