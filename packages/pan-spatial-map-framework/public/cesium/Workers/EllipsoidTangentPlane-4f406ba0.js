...
define(['exports', './AxisAlignedBoundingBox-531e5d90', './Cartesian2-cdd21d41', './Transforms-b24a46f8', './Check-c47ad5ed', './when-695b7bde', './IntersectionTests-0c88befc', './Plane-edc3d79e'], (function (exports, AxisAlignedBoundingBox, Cartesian2, Transforms, Check, when, IntersectionTests, Plane) { 'use strict';
    ...
    function EllipsoidTangentPlane(origin, ellipsoid) {
        ...
        this._origin = origin;
        this._xAxis = Cartesian2.Cartesian3.fromCartesian4(Transforms.Matrix4.getColumn(eastNorthUp, 0, scratchCart4));
        this._yAxis = Cartesian2.Cartesian3.fromCartesian4(Transforms.Matrix4.getColumn(eastNorthUp, 1, scratchCart4));

        var normal = Cartesian2.Cartesian3.fromCartesian4(Transforms.Matrix4.getColumn(eastNorthUp, 2, scratchCart4));
    ...
    EllipsoidTangentPlane.prototype.projectPointOntoPlane = function (cartesian, result) {
        ...
        if (when.defined(intersectionPoint)) {
            var v = Cartesian2.Cartesian3.subtract(intersectionPoint, this._origin, intersectionPoint);
...
//# sourceMappingURL=EllipsoidTangentPlane-4f406ba0.js.map
