...
define(['exports', './Cartesian2-cdd21d41', './Check-c47ad5ed', './when-695b7bde', './Transforms-b822f480', './WebGLConstants-35626ea2'], (function (exports, Cartesian2, Check, when, Transforms, WebGLConstants) { 'use strict';
    ...
    Matrix2.equals = function (left, right) {
        return left === right || (when.defined(left) && when.defined(right) && left[0] === right[0] && left[1] === right[1] && left[2] === right[2] && left[3] === right[3]);
    };
    ...
    function Geometry(options) {
         ...
         * @default undefined
         */
        this.primitiveType = when.defaultValue(options.primitiveType, PrimitiveType$1.TRIANGLES);
    ...
    Geometry.computeNumberOfVertices = function (geometry) {
        ...
        for (var property in geometry.attributes) {
            if (geometry.attributes.hasOwnProperty(property) && when.defined(geometry.attributes[property]) && when.defined(geometry.attributes[property].values)) {
    ...
    var boundingRectanglePointsCartographicScratch = [new Cartesian2.Cartographic(), new Cartesian2.Cartographic(), new Cartesian2.Cartographic()];
    ...
    Geometry._textureCoordinateRotationPoints = function (positions, stRotation, ellipsoid, boundingRectangle) {
        ...
        var enuCenter = Cartesian2.Cartographic.toCartesian(rectangleCenter, ellipsoid, enuCenterScratch);
        var enuToFixedFrame = Transforms.Transforms.eastNorthUpToFixedFrame(enuCenter, ellipsoid, fixedFrameToEnuScratch);
        var fixedFrameToEnu = Transforms.Matrix4.inverse(enuToFixedFrame, fixedFrameToEnuScratch);
        ...
        var rotation = Transforms.Quaternion.fromAxisAngle(Cartesian2.Cartesian3.UNIT_Z, -stRotation, enuRotationScratch);
        var textureMatrix = Transforms.Matrix3.fromQuaternion(rotation, enuRotationMatrixScratch);
        ...
        for (i = 0; i < positionsLength; i++) {
            posEnu = Transforms.Matrix4.multiplyByPointAsVector(fixedFrameToEnu, positions[i], posEnu);
...
//# sourceMappingURL=GeometryAttribute-13ef0da1.js.map
