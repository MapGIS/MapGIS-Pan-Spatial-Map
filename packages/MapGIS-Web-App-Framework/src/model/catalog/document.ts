...
/**
 * 地图文档查询参数结构（有domain用domain，没有则使用protocal、ip、port拼接而成）
 */
...
export interface LayerInfoQueryParam {
  ...
  ip?: string
  port?: string
  layerType?: string // layer、vector、tile
  gdbp?: string
  serverName?: string
}
...
export default class DocumentCatalog {
  // 地图文档图层信息
  public static globalDocInfo: Record<string, DocInfo> = {}
   ...
   */
  public static getTiles({ ip, port }) {
  ...
  public static getDocInfo(option: DocInfoQueryParam) {
  ...
  public static get3dDocInfo(option: DocInfoQueryParam) {
    if (!option.serverName) {
      return null
    }
    if (this.globalDocInfo[option.serverName]) {
   ...
   */
  public static getMapInfoService({ ip, port, name }) {
   ...
   * @returns                   图层索引列表
   */
  public static getLayerIndexesByNamesOrCodes(
   ...
   */
  public static getLayerUrlsByNamesOrCodes(
    data: MapInfoCatalogLayer[],
    layerName: string,
    code: string,
    urlArray: string[]
   ...
   */
  public static getLayersByIndexes(
    layerIdxs: string,
   ...
   * @returns                       图层URL(GDBP)列表
   */
  public static getLayerIndexesByNames(
    data: MapInfoCatalogLayer[],
    names: string,
    urlArray: string[]
  ) {
   ...
   * @returns                               图层列表
   */
  public static getLayersByExtentOrName(
    data: MapInfoCatalogLayer[],
    extent,
    layerNames,
    array,
   ...
   * @param queryParam
   */
  public static getLayerInfo(queryParam: LayerInfoQueryParam) {
