...
<script>
import MpMapWidgetIndicator from '../map-widget-indicator/MapWidgetIndicator.vue'
import MpMapPanel from '../map-panel/MapPanel.vue'
...
export default {
  ...
  name: 'MpAppLoader',
  // 依赖的组件
  components: { MpMapWidgetIndicator, MpMapPanel },
