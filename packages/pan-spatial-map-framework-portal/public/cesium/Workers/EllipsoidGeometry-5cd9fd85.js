...
define(['exports', './GeometryOffsetAttribute-ee7c1230', './Transforms-428723c7', './Cartesian2-a7398fe3', './ComponentDatatype-9859adcf', './when-ae2e0b60', './Check-f996273c', './GeometryAttribute-24498485', './GeometryAttributes-5ce4955a', './IndexDatatype-386a3275', './Math-ea295399', './VertexFormat-69b61abe'], (function (exports, GeometryOffsetAttribute, Transforms, Cartesian2, ComponentDatatype, when, Check, GeometryAttribute, GeometryAttributes, IndexDatatype, Math$1, VertexFormat) { 'use strict';
    ...
    var scratchNormalST = new Cartesian2.Cartesian3();
    ...
    function EllipsoidGeometry(options) {
        ...
        var maximumClock = when.defaultValue(options.maximumClock, Math$1.CesiumMath.TWO_PI);
        var minimumCone = when.defaultValue(options.minimumCone, 0.0);
        var maximumCone = when.defaultValue(options.maximumCone, Math$1.CesiumMath.PI);
        ...
        this._radii = Cartesian2.Cartesian3.clone(radii);
        this._innerRadii = Cartesian2.Cartesian3.clone(innerRadii);
     ...
     * @type {Number}
     */
    EllipsoidGeometry.packedLength = 2 * Cartesian2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength + 7;
    ...
    EllipsoidGeometry.pack = function (value, array, startingIndex) {
        ...
        Cartesian2.Cartesian3.pack(value._radii, array, startingIndex);
        startingIndex += Cartesian2.Cartesian3.packedLength;

        Cartesian2.Cartesian3.pack(value._innerRadii, array, startingIndex);
        startingIndex += Cartesian2.Cartesian3.packedLength;
    ...
    var scratchRadii = new Cartesian2.Cartesian3();
    var scratchInnerRadii = new Cartesian2.Cartesian3();
    ...
    EllipsoidGeometry.unpack = function (array, startingIndex, result) {
        ...
        var radii = Cartesian2.Cartesian3.unpack(array, startingIndex, scratchRadii);
        startingIndex += Cartesian2.Cartesian3.packedLength;

        var innerRadii = Cartesian2.Cartesian3.unpack(array, startingIndex, scratchInnerRadii);
        startingIndex += Cartesian2.Cartesian3.packedLength;
        ...
        result._radii = Cartesian2.Cartesian3.clone(radii, result._radii);
        result._innerRadii = Cartesian2.Cartesian3.clone(innerRadii, result._innerRadii);
    ...
    EllipsoidGeometry.createGeometry = function (ellipsoidGeometry) {
        ...
        slicePartitions = Math.round((slicePartitions * Math.abs(maximumClock - minimumClock)) / Math$1.CesiumMath.TWO_PI);
        stackPartitions = Math.round((stackPartitions * Math.abs(maximumCone - minimumCone)) / Math$1.CesiumMath.PI);
        ...
        if (vertexFormat.st || vertexFormat.normal || vertexFormat.tangent || vertexFormat.bitangent) {
            for (i = 0; i < vertexCount; i++) {
                ...
                var position = Cartesian2.Cartesian3.fromArray(positions, i * 3, scratchPosition);
                ...
                if (vertexFormat.st) {
                    ...
                    st[stIndex++] = Math.atan2(normalST.y, normalST.x) / Math$1.CesiumMath.TWO_PI + 0.5;
                ...
                if (vertexFormat.tangent || vertexFormat.bitangent) {
                    ...
                    if (!isTopOpen && i >= tangetOffset && i < tangetOffset + numThetas * 2) {
                        unit = Cartesian2.Cartesian3.UNIT_X;
                    } else {
                        unit = Cartesian2.Cartesian3.UNIT_Z;
                    }
                    Cartesian2.Cartesian3.cross(unit, normal, tangent);
                    ...
                    if (vertexFormat.bitangent) {
                        var bitangent = Cartesian2.Cartesian3.cross(normal, tangent, scratchBitangent);
                        Cartesian2.Cartesian3.normalize(bitangent, bitangent);
        ...
        if (!when.defined(unitEllipsoidGeometry)) {
            unitEllipsoidGeometry = EllipsoidGeometry.createGeometry(
                new EllipsoidGeometry({
                    radii: new Cartesian2.Cartesian3(1.0, 1.0, 1.0),
...
//# sourceMappingURL=EllipsoidGeometry-5cd9fd85.js.map
