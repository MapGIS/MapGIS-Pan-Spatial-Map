...
define(['exports', './Cartesian2-cdd21d41', './PolylineVolumeGeometryLibrary-8f3013c0', './when-695b7bde', './Math-2649012a', './Transforms-b24a46f8', './PolylinePipeline-9fbe400d'], (function (exports, Cartesian2, PolylineVolumeGeometryLibrary, when, Math$1, Transforms, PolylinePipeline) { 'use strict';
    ...
    function computeRoundCorner(cornerPoint, startPoint, endPoint, cornerType, leftIsOutside) {
        var angle = Cartesian2.Cartesian3.angleBetween(Cartesian2.Cartesian3.subtract(startPoint, cornerPoint, scratch1), Cartesian2.Cartesian3.subtract(endPoint, cornerPoint, scratch2));
        var granularity = cornerType === PolylineVolumeGeometryLibrary.CornerType.BEVELED ? 1 : Math.ceil(angle / Math$1.CesiumMath.toRadians(5)) + 1;
        ...
        var m;
        if (leftIsOutside) {
            m = Transforms.Matrix3.fromQuaternion(Transforms.Quaternion.fromAxisAngle(Cartesian2.Cartesian3.negate(cornerPoint, scratch1), angle / granularity, quaterion), rotMatrix);
        } else {
    ...
    function addEndCaps(calculatedPositions) {
        ...
        startPoint = Cartesian2.Cartesian3.fromArray(calculatedPositions[1], leftEdge.length - 3, startPoint);
        ...
        startPoint = Cartesian2.Cartesian3.fromArray(rightEdge, rightEdge.length - 3, startPoint);
    ...
    function computeMiteredCorner(position, leftCornerDirection, lastPoint, leftIsOutside) {
        ...
        if (leftIsOutside) {
            ...
            leftCornerDirection = Cartesian2.Cartesian3.negate(leftCornerDirection, leftCornerDirection);
            cornerPoint = Cartesian2.Cartesian3.add(position, leftCornerDirection, cornerPoint);
        }
    ...
    CorridorGeometryLibrary.computePositions = function (params) {
        ...
        forward = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.subtract(nextPosition, position, forward), forward);
        ...
        for (i = 1; i < length - 1; i++) {
            ...
            forward = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.subtract(nextPosition, position, forward), forward);
            cornerDirection = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.add(forward, backward, cornerDirection), cornerDirection);

            var forwardProjection = Cartesian2.Cartesian3.multiplyByScalar(normal, Cartesian2.Cartesian3.dot(forward, normal), scratchForwardProjection);
            ...
            var backwardProjection = Cartesian2.Cartesian3.multiplyByScalar(normal, Cartesian2.Cartesian3.dot(backward, normal), scratchBackwardProjection);
            ...
            var doCorner = !Math$1.CesiumMath.equalsEpsilon(Math.abs(Cartesian2.Cartesian3.dot(forwardProjection, backwardProjection)), 1.0, Math$1.CesiumMath.EPSILON7);

            if (doCorner) {
                cornerDirection = Cartesian2.Cartesian3.cross(cornerDirection, normal, cornerDirection);
                cornerDirection = Cartesian2.Cartesian3.cross(normal, cornerDirection, cornerDirection);
                cornerDirection = Cartesian2.Cartesian3.normalize(cornerDirection, cornerDirection);
                var scalar = width / Math.max(0.25, Cartesian2.Cartesian3.magnitude(Cartesian2.Cartesian3.cross(cornerDirection, backward, scratch1)));
                ...
                cornerDirection = Cartesian2.Cartesian3.multiplyByScalar(cornerDirection, scalar, cornerDirection);
                if (leftIsOutside) {
                    rightPos = Cartesian2.Cartesian3.add(position, cornerDirection, rightPos);
                    center = Cartesian2.Cartesian3.add(rightPos, Cartesian2.Cartesian3.multiplyByScalar(left, width, center), center);
                    leftPos = Cartesian2.Cartesian3.add(rightPos, Cartesian2.Cartesian3.multiplyByScalar(left, width * 2, leftPos), leftPos);
                    ...
                    left = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.cross(normal, forward, left), left);
                    leftPos = Cartesian2.Cartesian3.add(rightPos, Cartesian2.Cartesian3.multiplyByScalar(left, width * 2, leftPos), leftPos);
                    previousPos = Cartesian2.Cartesian3.add(rightPos, Cartesian2.Cartesian3.multiplyByScalar(left, width, previousPos), previousPos);
                    if (cornerType === PolylineVolumeGeometryLibrary.CornerType.ROUNDED || cornerType === PolylineVolumeGeometryLibrary.CornerType.BEVELED) {
                        ...
                        corners.push({
                            leftPositions: computeMiteredCorner(position, Cartesian2.Cartesian3.negate(cornerDirection, cornerDirection), leftPos, leftIsOutside)
                        });
                    }
                } else {
                    leftPos = Cartesian2.Cartesian3.add(position, cornerDirection, leftPos);
                    center = Cartesian2.Cartesian3.add(leftPos, Cartesian2.Cartesian3.negate(Cartesian2.Cartesian3.multiplyByScalar(left, width, center), center), center);
                    rightPos = Cartesian2.Cartesian3.add(leftPos, Cartesian2.Cartesian3.negate(Cartesian2.Cartesian3.multiplyByScalar(left, width * 2, rightPos), rightPos), rightPos);
                    scaleArray2[0] = Cartesian2.Cartesian3.clone(previousPos, scaleArray2[0]);
                    scaleArray2[1] = Cartesian2.Cartesian3.clone(center, scaleArray2[1]);
                    subdividedPositions = PolylinePipeline.PolylinePipeline.generateArc({
                        positions: scaleArray2,
                    ...
                    left = Cartesian2.Cartesian3.normalize(Cartesian2.Cartesian3.cross(normal, forward, left), left);
                    rightPos = Cartesian2.Cartesian3.add(leftPos, Cartesian2.Cartesian3.negate(Cartesian2.Cartesian3.multiplyByScalar(left, width * 2, rightPos), rightPos), rightPos);
                    previousPos = Cartesian2.Cartesian3.add(leftPos, Cartesian2.Cartesian3.negate(Cartesian2.Cartesian3.multiplyByScalar(left, width, previousPos), previousPos), previousPos);
                    if (cornerType === PolylineVolumeGeometryLibrary.CornerType.ROUNDED || cornerType === PolylineVolumeGeometryLibrary.CornerType.BEVELED) {
                        corners.push({
...
//# sourceMappingURL=CorridorGeometryLibrary-a7aa3a93.js.map
