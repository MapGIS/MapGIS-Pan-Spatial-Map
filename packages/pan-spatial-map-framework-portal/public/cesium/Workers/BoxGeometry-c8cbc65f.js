...
define(['exports', './GeometryOffsetAttribute-ee7c1230', './Transforms-428723c7', './Cartesian2-a7398fe3', './Check-f996273c', './ComponentDatatype-9859adcf', './when-ae2e0b60', './GeometryAttribute-24498485', './GeometryAttributes-5ce4955a', './VertexFormat-69b61abe'], (function (exports, GeometryOffsetAttribute, Transforms, Cartesian2, Check, ComponentDatatype, when, GeometryAttribute, GeometryAttributes, VertexFormat) { 'use strict';
    ...
    function BoxGeometry(options) {
        ...
        this._minimum = Cartesian2.Cartesian3.clone(min);
        this._maximum = Cartesian2.Cartesian3.clone(max);
     ...
     * @type {Number}
     */
    BoxGeometry.packedLength = 2 * Cartesian2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength + 1;
    ...
    BoxGeometry.pack = function (value, array, startingIndex) {
        ...
        Cartesian2.Cartesian3.pack(value._minimum, array, startingIndex);
        Cartesian2.Cartesian3.pack(value._maximum, array, startingIndex + Cartesian2.Cartesian3.packedLength);
        VertexFormat.VertexFormat.pack(value._vertexFormat, array, startingIndex + 2 * Cartesian2.Cartesian3.packedLength);
        array[startingIndex + 2 * Cartesian2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength] = when.defaultValue(value._offsetAttribute, -1);
    ...
    BoxGeometry.unpack = function (array, startingIndex, result) {
        ...
        var vertexFormat = VertexFormat.VertexFormat.unpack(array, startingIndex + 2 * Cartesian2.Cartesian3.packedLength, scratchVertexFormat);
        var offsetAttribute = array[startingIndex + 2 * Cartesian2.Cartesian3.packedLength + VertexFormat.VertexFormat.packedLength];
        ...
        result._minimum = Cartesian2.Cartesian3.clone(min, result._minimum);
        result._maximum = Cartesian2.Cartesian3.clone(max, result._maximum);
        ...
        if (!when.defined(unitBoxGeometry)) {
            unitBoxGeometry = BoxGeometry.createGeometry(
                BoxGeometry.fromDimensions({
                    dimensions: new Cartesian2.Cartesian3(1.0, 1.0, 1.0),
...
//# sourceMappingURL=BoxGeometry-c8cbc65f.js.map
