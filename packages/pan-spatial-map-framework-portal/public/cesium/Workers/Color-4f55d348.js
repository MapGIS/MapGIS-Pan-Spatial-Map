...
define(['exports', './Check-f996273c', './when-ae2e0b60', './Transforms-49d48c2d', './Math-ea295399'], (function (exports, Check, when, Transforms, Math$1) { 'use strict';
    ...
    function Color(red, green, blue, alpha) {
         ...
         * @default 1.0
         */
        this.red = isCesiumColorNumber();
        /**
         * The green component.
         * @type {Number}
         * @default 1.0
         */
        this.green = isCesiumColorNumber();
        /**
         * The blue component.
         * @type {Number}
         * @default 1.0
         */
        this.blue = isCesiumColorNumber();
        /**
         * The alpha component.
         * @type {Number}
         * @default 1.0
         */
        this.alpha = isCesiumColorNumber();
    }
    ...
    Color.fromBytes = function (red, green, blue, alpha, result) {
        red = Color.byteToFloat(isCssColorNumber());
        green = Color.byteToFloat(isCssColorNumber());
        blue = Color.byteToFloat(isCssColorNumber());
        alpha = Color.byteToFloat(isCssColorNumber());
    ...
    Color.fromAlpha = function (color, alpha, result) {
        ...
        result.alpha = isCesiumColorNumber();
        return result;
    };
    ...
    Color.fromHsl = function (hue, saturation, lightness, alpha, result) {
        hue = isCesiumColorNumber();
        saturation = isCesiumColorNumber();
        lightness = isCesiumColorNumber();
        alpha = isCesiumColorNumber();
...
//# sourceMappingURL=Color-4f55d348.js.map
