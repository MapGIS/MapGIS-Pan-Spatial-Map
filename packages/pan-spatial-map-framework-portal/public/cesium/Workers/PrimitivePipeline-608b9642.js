...
define(['exports', './Transforms-b822f480', './ComponentDatatype-66ac9db6', './when-695b7bde', './Check-c47ad5ed', './Cartesian2-cdd21d41', './GeometryAttribute-13ef0da1', './GeometryAttributes-5198def4', './GeometryPipeline-43f2fbf4', './IndexDatatype-a938a6f6', './WebMercatorProjection-1815fed5'], (function (exports, Transforms, ComponentDatatype, when, Check, Cartesian2, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, WebMercatorProjection) { 'use strict';
    ...
    function countCreateGeometryResults(items) {
        ...
        for (var i = 0; i < length; i++) {
            ...
            count += 7 + 2 * Transforms.BoundingSphere.packedLength + (when.defined(geometry.indices) ? geometry.indices.length : 0);
...
//# sourceMappingURL=PrimitivePipeline-608b9642.js.map
