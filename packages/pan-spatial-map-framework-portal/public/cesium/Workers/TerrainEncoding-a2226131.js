...
define(['exports', './Transforms-399eae97', './Cartesian2-a7398fe3', './Check-f996273c', './when-ae2e0b60', './AttributeCompression-f3b8d6f8', './ComponentDatatype-9859adcf', './Math-ea295399'], (function (exports, Transforms, Cartesian2, Check, when, AttributeCompression, ComponentDatatype, Math$1) { 'use strict';
    ...
    function isScaledSpacePointVisible(occludeeScaledSpacePosition, cameraPositionInScaledSpace, distanceToLimbInScaledSpaceSquared) {
        ...
        var isOccluded = vhMagnitudeSquared < 0 ? vtDotVc > 0 : vtDotVc > vhMagnitudeSquared && (vtDotVc * vtDotVc) / Cartesian2.Cartesian3.magnitudeSquared(vt) > vhMagnitudeSquared;
        return !isOccluded;
    }
    ...
    TerrainExaggeration.getPosition = function (position, ellipsoid, terrainExaggeration, terrainExaggerationRelativeHeight, result) {
        ...
        return Cartesian2.Cartesian3.fromRadians(cartographic.longitude, cartographic.latitude, newHeight, ellipsoid, result);
    };
    ...
    function TerrainEncoding(
         ...
         * @type {Boolean}
         */
        this.hasGeodeticSurfaceNormals = when.defaultValue(hasGeodeticSurfaceNormals, false);
         ...
         */
        this.exaggerationRelativeHeight = when.defaultValue(exaggerationRelativeHeight, 0.0);
    ...
    TerrainEncoding.prototype.encode = function (vertexBuffer, bufferIndex, position, uv, height, normalToPack, webMercatorT, geodeticSurfaceNormal) {
        ...
        if (this.quantization === TerrainQuantization$1.BITS12) {
            ...
            var h = Math$1.CesiumMath.clamp((height - this.minimumHeight) / hDim, 0.0, 1.0);
...
//# sourceMappingURL=TerrainEncoding-a2226131.js.map
