...
define(['exports', './Cartesian2-a7398fe3', './when-ae2e0b60', './Check-f996273c', './EllipsoidGeodesic-cb933765', './EllipsoidRhumbLine-363aba07', './IntersectionTests-39b1768f', './Math-ea295399', './Transforms-399eae97', './Plane-713aec94'], (function (exports, Cartesian2, when, Check, EllipsoidGeodesic, EllipsoidRhumbLine, IntersectionTests, Math$1, Transforms, Plane) { 'use strict';
    ...
    PolylinePipeline.wrapLongitude = function (positions, modelMatrix) {
        ...
        if (when.defined(positions) && positions.length > 0) {
            ...
            var inverseModelMatrix = Transforms.Matrix4.inverseTransformation(modelMatrix, wrapLongitudeInversMatrix);

            var origin = Transforms.Matrix4.multiplyByPoint(inverseModelMatrix, Cartesian2.Cartesian3.ZERO, wrapLongitudeOrigin);
            var xzNormal = Cartesian2.Cartesian3.normalize(Transforms.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Cartesian2.Cartesian3.UNIT_Y, wrapLongitudeXZNormal), wrapLongitudeXZNormal);
            var xzPlane = Plane.Plane.fromPointNormal(origin, xzNormal, wrapLongitudeXZPlane);
            var yzNormal = Cartesian2.Cartesian3.normalize(Transforms.Matrix4.multiplyByPointAsVector(inverseModelMatrix, Cartesian2.Cartesian3.UNIT_X, wrapLongitudeYZNormal), wrapLongitudeYZNormal);
            ...
            for (var i = 1; i < length; ++i) {
                ...
                if (Plane.Plane.getPointDistance(yzPlane, prev) < 0.0 || Plane.Plane.getPointDistance(yzPlane, cur) < 0.0) {
                    ...
                    if (when.defined(intersection)) {
                        ...
                        var offset = Cartesian2.Cartesian3.multiplyByScalar(xzNormal, 5.0e-9, wrapLongitudeOffset);
                        if (Plane.Plane.getPointDistance(xzPlane, prev) < 0.0) {
                            Cartesian2.Cartesian3.negate(offset, offset);
                        }

                        cartesians.push(Cartesian2.Cartesian3.add(intersection, offset, new Cartesian2.Cartesian3()));
...
//# sourceMappingURL=PolylinePipeline-5db0bf8a.js.map
