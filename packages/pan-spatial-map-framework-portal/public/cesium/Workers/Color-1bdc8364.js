...
define(['exports', './Check-f996273c', './when-ae2e0b60', './Transforms-49d48c2d', './Math-ea295399'], (function (exports, Check, when, Transforms, Math$1) { 'use strict';
    ...
    var CoreUtil = {
        isCesiumColorNumber: function() {
            
        },
        isCssColorNumber: function() {
            
        },
        isCssString: function() {
    ...
    function Color(red, green, blue, alpha) {
         ...
         * @default 1.0
         */
        this.red = CoreUtil.isCesiumColorNumber(when.defaultValue(red, 1.0));
        /**
         * The green component.
         * @type {Number}
         * @default 1.0
         */
        this.green = CoreUtil.isCesiumColorNumber(when.defaultValue(green, 1.0));
        /**
         * The blue component.
         * @type {Number}
         * @default 1.0
         */
        this.blue = CoreUtil.isCesiumColorNumber(when.defaultValue(blue, 1.0));
        /**
         * The alpha component.
         * @type {Number}
         * @default 1.0
         */
        this.alpha = CoreUtil.isCesiumColorNumber(when.defaultValue(alpha, 1.0));
    }
    ...
    Color.fromCartesian4 = function (cartesian, result) {
        ...
        result.red = CoreUtil.isCesiumColorNumber(cartesian.x);
        result.green = CoreUtil.isCesiumColorNumber(cartesian.y);
        result.blue = CoreUtil.isCesiumColorNumber(cartesian.z);
        result.alpha = CoreUtil.isCesiumColorNumber(cartesian.w);
        return result;
    };
    ...
    Color.fromBytes = function (red, green, blue, alpha, result) {
        red = Color.byteToFloat(CoreUtil.isCssColorNumber(when.defaultValue(red, 255.0)));
        green = Color.byteToFloat(CoreUtil.isCssColorNumber(when.defaultValue(green, 255.0)));
        blue = Color.byteToFloat(CoreUtil.isCssColorNumber(when.defaultValue(blue, 255.0)));
        alpha = Color.byteToFloat(CoreUtil.isCssColorNumber(when.defaultValue(alpha, 255.0)));
    ...
    Color.fromAlpha = function (color, alpha, result) {
        ...
        result.red = CoreUtil.isCesiumColorNumber(color.red);
        result.green = CoreUtil.isCesiumColorNumber(color.green);
        result.blue = CoreUtil.isCesiumColorNumber(color.blue);
        result.alpha = CoreUtil.isCesiumColorNumber(alpha);
        return result;
    };
    ...
    Color.fromHsl = function (hue, saturation, lightness, alpha, result) {
        hue = CoreUtil.isCesiumColorNumber(when.defaultValue(hue, 0.0) % 1.0);
        saturation = CoreUtil.isCesiumColorNumber(when.defaultValue(saturation, 0.0));
        lightness = CoreUtil.isCesiumColorNumber(when.defaultValue(lightness, 0.0));
        alpha = CoreUtil.isCesiumColorNumber(when.defaultValue(alpha, 1.0));
    ...
    Color.fromCssColorString = function (color, result) {
        ...
        if (!CoreUtil.isCssString(color, JSON.parse(JSON.stringify(Color)))) {
...
//# sourceMappingURL=Color-1bdc8364.js.map
