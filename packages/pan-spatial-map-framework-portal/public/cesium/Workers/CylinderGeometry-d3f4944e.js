...
define(['exports', './GeometryOffsetAttribute-ee7c1230', './Transforms-428723c7', './Cartesian2-a7398fe3', './ComponentDatatype-9859adcf', './CylinderGeometryLibrary-e08286a0', './when-ae2e0b60', './Check-f996273c', './GeometryAttribute-24498485', './GeometryAttributes-5ce4955a', './IndexDatatype-386a3275', './Math-ea295399', './VertexFormat-69b61abe'], (function (exports, GeometryOffsetAttribute, Transforms, Cartesian2, ComponentDatatype, CylinderGeometryLibrary, when, Check, GeometryAttribute, GeometryAttributes, IndexDatatype, Math$1, VertexFormat) { 'use strict';
    ...
    CylinderGeometry.createGeometry = function (cylinderGeometry) {
        ...
        if (computeNormal) {
            ...
            for (i = 0; i < slices; i++) {
                var angle = (i / slices) * Math$1.CesiumMath.TWO_PI;
        ...
        if (vertexFormat.st) {
            ...
            for (i = 0; i < numVertices; i++) {
                var position = Cartesian2.Cartesian3.fromArray(positions, i * 3, positionScratch);
...
//# sourceMappingURL=CylinderGeometry-d3f4944e.js.map
