...
define(['exports', './ArcType-1275a14e', './arrayRemoveDuplicates-3d6044aa', './Cartesian2-a7398fe3', './ComponentDatatype-9859adcf', './when-ae2e0b60', './EllipsoidRhumbLine-363aba07', './GeometryAttribute-24498485', './GeometryAttributes-5ce4955a', './GeometryPipeline-37decdab', './IndexDatatype-386a3275', './Math-ea295399', './Transforms-428723c7', './PolygonPipeline-44e3c2a1'], (function (exports, ArcType, arrayRemoveDuplicates, Cartesian2, ComponentDatatype, when, EllipsoidRhumbLine, GeometryAttribute, GeometryAttributes, GeometryPipeline, IndexDatatype, Math$1, Transforms, PolygonPipeline) { 'use strict';
    ...
    PolygonGeometryLibrary.computeWallGeometry = function (positions, ellipsoid, granularity, perPositionHeight, arcType) {
        ...
        for (i = 0; i < length; i++) {
            ...
            if (Cartesian2.Cartesian3.equalsEpsilon(p1, p2, Math$1.CesiumMath.EPSILON10, Math$1.CesiumMath.EPSILON10)) {
                //skip corner
                continue;
            }
...
//# sourceMappingURL=PolygonGeometryLibrary-f38243d7.js.map
