...
define(['exports', './Cartesian2-a7398fe3', './Check-f996273c', './when-ae2e0b60', './Math-ea295399'], (function (exports, Cartesian2, Check, when, Math$1) { 'use strict';
    ...
    function vincentyInverseFormula(ellipsoidGeodesic, major, minor, firstLongitude, firstLatitude, secondLongitude, secondLatitude) {
        ...
        var lambda = l;
        var lambdaDot = Math$1.CesiumMath.TWO_PI;
    ...
    function computeProperties(ellipsoidGeodesic, start, end, ellipsoid) {
        ...
        ellipsoidGeodesic._start = Cartesian2.Cartographic.clone(start, ellipsoidGeodesic._start);
        ellipsoidGeodesic._end = Cartesian2.Cartographic.clone(end, ellipsoidGeodesic._end);
    ...
    EllipsoidGeodesic.prototype.interpolateUsingSurfaceDistance = function (distance, result) {
        ...
        return new Cartesian2.Cartographic(this._start.longitude + l, latitude, 0.0);
    };

    exports.EllipsoidGeodesic = EllipsoidGeodesic;

}));
//# sourceMappingURL=EllipsoidGeodesic-cb933765.js.map
