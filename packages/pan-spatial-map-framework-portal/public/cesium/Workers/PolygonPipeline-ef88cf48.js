...
define(['exports', './Cartesian2-cdd21d41', './Check-c47ad5ed', './ComponentDatatype-66ac9db6', './when-695b7bde', './EllipsoidRhumbLine-a01090e1', './GeometryAttribute-c51140aa', './Math-2649012a', './WebGLConstants-35626ea2'], (function (exports, Cartesian2, Check, ComponentDatatype, when, EllipsoidRhumbLine, GeometryAttribute, Math$1, WebGLConstants) { 'use strict';
    ...
    PolygonPipeline.computeSubdivision = function (ellipsoid, positions, indices, granularity) {
        granularity = when.defaultValue(granularity, Math$1.CesiumMath.RADIANS_PER_DEGREE);
        ...
        var minDistance = Math$1.CesiumMath.chordLength(granularity, radius);
...
//# sourceMappingURL=PolygonPipeline-ef88cf48.js.map
